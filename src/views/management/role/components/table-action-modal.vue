...
// function dataChange(formModel: { index: string | null; id: string | null; beer_name: string | null; style: string | null; ounces: string | null; abv: string | null; brewery_id: string | null; brewery_name: string | null; city: string | null; state: string | null; }, type: string) {
